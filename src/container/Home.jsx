...
const Home = () => {
  return (
    <Wrapper>
      <Navbar />
      <Container>
        <div className="grid grid-cols-2 text-xl mt-[36px]  font-extrabold">
          ...
          <div className="col-span-2 flex flex-row border-t-[2px] border-[#b7b7b7] mt-[10px] pt-[25px]">
            <h1 className="w-1/2 flex items-center justify-center text-xl">
              TOTAL
            </h1>
        ...
        <div className="mt-[100px]">
          <h1 className="text-xl text-center font-extrabold mb-[42px]">
            사용중인 법령 정보
          </h1>
          <ul className="text-base">
            <li className="mb-[24px] flex items-start">
